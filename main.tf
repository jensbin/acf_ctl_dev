...
module "network" {
  source     = "git::https://oauth2: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@github.com/avaloqcloud/acf_res_net.git"
